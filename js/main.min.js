...
const response = await fetch(
  `https://geocode-maps.yandex.ru/1.x/?apikey=4ada92ff-840e-41e0-aa45-c7bd1b163e52&geocode=37,2123,37.2311&format=json`
);
...
class App {
  ...
  async _getCoordinateAPI(lng, lat) {
    const response = await fetch(
  ...
  _newWorkout(e) {
    ...
    this._getCoordinateAPI(lng, lat);
